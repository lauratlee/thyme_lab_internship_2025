...
for system in systems_dict.keys():
	...
	#for the generated native conformer, make a folder based on the conformer and move the file into the folder
	...
	restype_file.write("ligand.params\n")
	restype_file.close()
